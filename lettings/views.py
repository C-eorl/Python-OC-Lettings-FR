...
def index(request):
    """
    FBV display index view lettings app
...
# Ut quis urna pellentesque justo mattis ullamcorper ac non tellus. In tristique mauris
...
def letting(request, letting_id):
    """
    FBV display one location via id
    ...
    try:
        ...
        sentry_sdk.capture_message(f"Letting: {letting_id} does not exist")
        raise Http404
